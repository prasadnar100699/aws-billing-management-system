            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="flex items-center space-x-2 mt-2">
                  <Badge data-testid="user-role-badge" className={
                    user.role_name === 'Super Admin' ? 'bg-blue-100 text-blue-800' :
                    user.role_name === 'Admin' ? 'bg-green-100 text-green-800' :
                    user.role_name === 'Manager' ? 'bg-purple-100 text-purple-800' :
                    user.role_name === 'Accountant' ? 'bg-orange-100 text-orange-800' :
                  ...
                  <span className="text-sm text-gray-600">
                    AWS Billing Management System
                  </span>
                </div>
              </div>
              <div className="flex space-x-2">
                {hasPermission('invoices', 'create') && (
                  <Button data-testid="create-invoice-quick-action" onClick={() => window.location.href = '/invoices'} className="bg-blue-600 hover:bg-blue-700">
                    <Plus className="w-4 h-4 mr-2" />
                    Create Invoice
                  </Button>
                )}
                {isSuperAdmin() && (
                  <Button data-testid="settings-quick-action" variant="outline" onClick={() => window.location.href = '/settings'}>
                ...
                <CardContent>
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="text-right">
                              <Badge className={
                                ...
                                activity.status === 'approved' ? 'bg-purple-100 text-purple-800' :
                                'bg-gray-100 text-gray-800'
                              }>
                                {activity.status}
                              </Badge>
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                      ...
                      {hasPermission('usage_import', 'create') && (
